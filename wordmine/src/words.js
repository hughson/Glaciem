// 5-letter solution wordlist for Wordmine. Curated set of common English
// words. Server picks one uniformly at random per game.
export const WORDS = [
  ...
  "BENCH","BIRTH","BLACK","BLAME","BLIND","BLOCK","BLOOD","BOARD","BOAST","BOOST",
  ...
  "GUARD","GUESS","GUEST","GUIDE","HAPPY","HARRY","HEART","HEAVY","HENCE","HORSE",
  ...
  "WROTE","YIELD","YOUNG","YOUTH","ZEBRA","ZESTY","ZONAL",
  // glaciem-themed seeds for fun
  "FROST","BLOCK","CHAIN","MINER","NONCE","CHILL","SNOWY","ICILY","GLINT",
];
